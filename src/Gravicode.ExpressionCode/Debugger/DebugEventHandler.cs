...
// Type: Gravicode.ExpressionCode.Debugger.DebugEventHandler
...
namespace Gravicode.ExpressionCode.Debugger
{
  public delegate void DebugEventHandler(ScriptEngine sender, DebugEventArgs e);
}
